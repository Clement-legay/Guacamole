        ...
        <div class="row">
            <div class="col-4">
                <a href="{{ route('watch', $video->id()) }}">
                    <img class="card-img-top" src="{{ asset($video->thumbnail) }}" alt="{{ $video->name }}">
                </a>
            </div>
            <div class="col-8">
                    ...
                    <div class="col-12 ms-3 mt-3">
                        <div class="row align-content-start">
                            <div class="col-auto p-0">
                                <a style="text-decoration: none" href="{{ route('channel', base64_encode($video->user()->first()->id)) }}">
                            ...
                            <div class="col-auto pt-1 mt-1">
                                <a class="card-text text-black-50 text-body" style="text-decoration: none" href="{{ route('channel', base64_encode($video->user()->first()->id)) }}">{{ $video->user()->first()->username }}</a>
                            </div>
                        </div>
                    </div>
